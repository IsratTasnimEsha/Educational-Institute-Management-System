<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_course.aspx.cs" Inherits="HMIT.view_course" %>
        ...
        <nav>
            ...
            <div class="nav-links" id="navLinks">
                ...
                <ul>
                    ...
                    <li><a href="add_courses.aspx">ADD COURSES</a></li>
                    ...
                    <asp:UpdatePanel runat="server" ID="updatePanel" UpdateMode="Conditional">
                        <ContentTemplate>
                            <section class="table_header" style="padding-left: 40px; padding-right: 40px;">
                                ...
                                <div>
                                    <label for="search" style="font-weight: bold;">Search Course No. Or Title</label>
                            ...
                            <section class="table_body">
                                <asp:GridView ID="GridViewCourses" runat="server" AutoGenerateColumns="False" DataKeyNames="course_no" CssClass="gridview" OnRowDataBound="GridViewCourses_RowDataBound">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="course_no" HeaderText="Course No." ItemStyle-HorizontalAlign="Center" />
