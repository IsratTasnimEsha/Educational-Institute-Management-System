<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="view_teacher.aspx.cs" Inherits="HMIT.view_teacher" %>
                    ...
                    <ContentTemplate>
                        <section class="table_header" style="padding-left: 40px; padding-right: 40px;">
                            ...
                            <div>
                                ...
                                <asp:DropDownList ID="designation" style="width: 100%;" CssClass="dropdown" runat="server" OnSelectedIndexChanged="year_SelectedIndexChanged" AutoPostBack="True">
                                    <asp:ListItem Text="" Value=""></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <div>
                        ...
                        <section class="table_body">
                            <asp:GridView ID="GridViewTeachers" runat="server" AutoGenerateColumns="False" DataKeyNames="teacher_id" CssClass="gridview" OnRowDataBound="GridViewTeachers_RowDataBound">
                                ...
                                <Columns>                              
                                    ...
                                    <asp:BoundField DataField="teacher_id" HeaderText="ID" ItemStyle-HorizontalAlign="Center" />
                                    <asp:BoundField DataField="teacher_name" HeaderText="Name" ItemStyle-HorizontalAlign="Center" />
